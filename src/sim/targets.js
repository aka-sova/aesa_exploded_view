...
export class Target {
  constructor(id, azDeg, elDeg, rangeFrac, vazDeg, velDeg, rcs) {
    this.id = id;
    this.az = azDeg * deg;
    this.el = elDeg * deg;
...
// az°, el°, range (× DOME_RADIUS), az rate °/s, el rate °/s, RCS m²
const INITIAL = [
  [-35, 12, 0.72, 2.2, 0.6, 20],
  [10, 28, 0.85, -1.6, 0.9, 5],
  [42, 8, 0.66, -2.8, 1.2, 2],
  [-12, 38, 0.92, 1.4, -1.1, 1],
  [25, 18, 0.9, -3.5, -0.7, 0.5],
];

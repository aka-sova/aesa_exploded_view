...
export const tutorialEn = {
  ...
  'tut.doppler.try': 'Switch MTI on and watch the ridge — and T2, which sits at a blind speed — vanish; move PRF and watch T2 reappear while the range axis folds.',
...
export const tutorialRu = {
  ...
  'tut.doppler.try': 'Включите СДЦ и наблюдайте, как исчезают гребень и T2 (она на слепой скорости); изменяйте ЧПИ — T2 появится снова, а ось дальности свернётся.',

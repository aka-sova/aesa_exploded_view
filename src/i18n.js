...
const ru = {
  ...
  'tel.scanLossDb': 'ПОТЕРИ СКАНИР.', 'tel.prf': 'ЧПИ', 'tel.unambRangeKm': 'ОДНОЗНАЧН. ДАЛЬНОСТЬ', 'tel.dutyCycle': 'СКВАЖНОСТЬ',
  'tel.peakPowerKw': 'ПИКОВАЯ МОЩН.', 'tel.avgPowerKw': 'СРЕДНЯЯ МОЩН.', 'tel.activeElements': 'АКТИВНЫХ ЭЛЕМЕНТОВ', 'tel.activeBeams': 'ЛУЧЕЙ',
  'tel.tracked': 'ТРАСС', 'tel.detected': 'ОБНАРУЖЕНИЙ', 'tel.hops': 'СКАЧКОВ ЛУЧА', 'tel.dwellMs': 'ДИСКРЕТ',
  'tel.pulsesPerDwell': 'ИМПУЛЬСОВ / ДИСКРЕТ', 'tel.eirpLossDb': 'ПОТЕРИ ЭИИМ', 'tel.arrayTempC': 'ТЕМП. РЕШЁТКИ',
  'tel.pulsesSent': 'ИМПУЛЬСОВ ИЗЛУЧЕНО', 'tel.echoes': 'ЭХО-СИГНАЛОВ',
